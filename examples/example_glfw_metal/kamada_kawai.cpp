...
namespace nodesoup
{
    ...
    KamadaKawai::KamadaKawai(const adj_list_t &aAdjList, double aK, double aEnergyThreshold)
        : m_AdjList(aAdjList), m_EnergyThreshold(aEnergyThreshold), m_K(aK), m_SteadyEnergyCount(0), m_MaxVertexEnergy(0.0), m_VertexId(0), m_Scale(1.0)
    {
    }
    ...
    void KamadaKawai::Start(bool aStartCircle)
    {
        ...
        m_MaxVertexEnergy = std::get<0>(res);
        m_VertexId = std::get<1>(res);
    }
